...
<main>
  ...
  <section class="relative z-10 bg-blue-900 py-[120px] min-h-screen">
      ...
      <div class="-mx-4 flex">
        <div class="w-full px-4">
          <div class="mx-auto max-w-[400px] text-center">
            ...
            <a href="/" class="inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white hover:text-blue-900">
              Go To Home
            </a>
          </div>
        </div>
